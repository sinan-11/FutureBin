...
import { FaLeaf, FaHome, FaSignOutAlt, FaArrowLeft, FaCalendarAlt, FaSpinner } from "react-icons/fa";
      ...
      <header className="bg-brand-700/95 shadow-lg shadow-brand-900/20 backdrop-blur-xl border-b border-white/10">
        <div className="mx-auto flex max-w-2xl items-center justify-between px-4 py-3 md:px-8 md:py-4">
          ...
          <div className="flex items-center gap-1 sm:gap-1.5">
            ...
            >
              <FaArrowLeft className="h-3.5 w-3.5" /> Subscriptions
            </Link>
            <button
      ...
      <main className="mx-auto max-w-2xl px-4 py-6">
        <div className="mb-6 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400">Automate your waste pickups</p>
          </div>
        </div>
